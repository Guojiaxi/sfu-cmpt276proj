...
module.exports = function(app) {
    ...
    app.get('/home_none', (req, res) => res.render('home_none'))
    ...
    app.get('/meetup_none', (req, res) => res.render('meetups_none'))
        ...
        try {
            pool.query(viewQuery, (error, result) => {
                if (error) {
                    ...
                    var results = { 'results': result.rows }
                    res.render('meetup_edit', results);
                }
    ...
    app.get('/burnaby_events', (req, res) => {
        var eventsQuery = 'SELECT name, host_name, url, location, start_datetime,'+
            'TO_CHAR(start_datetime, \'Mon DD\') start_date,'+
            'TO_CHAR(start_datetime, \'HH:MI\') start_time,'+
            'TO_CHAR(end_datetime, \'Mon DD\') end_date,'+
            'TO_CHAR(end_datetime, \'HH:MI\') end_time '+
